...
> ## **THIS IS AI SLOP, USER BEWARE**
>
> **This code was generated by an AI (Hermes Agent / GLM). It has never been audited
> by a human cryptography expert. Do NOT trust it with real money without having it
> professionally audited first. If you use it and lose funds, that is entirely on you.
> Read the engineering log below — the AI itself found four real bugs in its own
> first draft, three of which passed the official test vectors.**
